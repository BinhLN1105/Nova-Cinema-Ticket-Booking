...
import { movieApi, reviewApi } from "@/api/endpoints";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-10 pt-20">
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <span
                  className={cn("badge text-xs", getRatedColor(movie.rated))}
                >
                  {movie.rated}
                </span>
              </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 space-y-8">
            ...
            >
              ...
              <p className="text-cinema-200 leading-relaxed">
                {movie.description}
              </p>
            </motion.div>
              ...
              >
                ...
                <div className="space-y-3">
                  {reviews.content.slice(0, 4).map((review) => (
                    <div
                      key={review.id}
                      className="p-4 rounded-xl bg-cinema-800/60 border border-white/5"
                    >
                      <div className="flex items-center gap-3 mb-2">
                        <div
                          className="w-8 h-8 rounded-full bg-brand-500/20 flex items-center
                      ...
                      <p className="text-cinema-200 text-sm">
                        {review.comment}
                      </p>
                    </div>
                  ))}
            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="space-y-3">
                {movie.status === "NOW_SHOWING" && (
                  <button
                    onClick={() => navigate(`/booking/showtime/${movie.id}`)}
