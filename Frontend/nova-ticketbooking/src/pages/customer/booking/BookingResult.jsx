        ...
        {isSuccess ? (
          <>
            ...
            <p className="text-cinema-300 mb-8">
              Vé điện tử đã được gửi vào email của bạn. Chúc bạn xem phim vui
              vẻ!
            </p>
          ...
          <>
            <div
              className="w-24 h-24 rounded-full bg-brand-500/15 border-2 border-brand-500/40
              flex items-center justify-center mx-auto mb-6"
            >
            ...
            <p className="text-cinema-300 mb-8">
              Giao dịch không thành công. Vé của bạn vẫn được giữ trong 10 phút.
            </p>
            <Link to="/tickets" className="btn-primary px-6 py-3">
              Thử lại
            </Link>
