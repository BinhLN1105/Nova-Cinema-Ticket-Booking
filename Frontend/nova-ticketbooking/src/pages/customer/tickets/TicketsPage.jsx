  ...
  return (
    <div className="min-h-screen bg-cinema-900 pt-24 pb-16">
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
        <div className="mb-8">
          <h1 className="font-display text-3xl font-bold text-white mb-1">Vé của tôi</h1>
          <p className="text-cinema-300">Lịch sử đặt vé và vé đang có hiệu lực</p>
        </div>
                ...
                return (
                  <motion.div key={booking.id}
                    ...
                    <Link to={`/tickets/${booking.id}`}
                      className="flex items-center gap-4 card-cinema p-4 group hover:bg-cinema-800 transition-colors">
            ...
            {hasNextPage && (
              <div className="mt-8 text-center">
                <button 
                  ...
                  className="btn-outline px-6 py-2.5 rounded-full inline-flex items-center gap-2 text-cinema-300 hover:text-white"
                >
