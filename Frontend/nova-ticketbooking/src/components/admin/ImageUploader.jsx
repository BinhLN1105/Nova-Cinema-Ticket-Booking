  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-end">
        <div>
          <label className="block text-sm font-semibold mb-1 text-slate-900 dark:text-white">{label}</label>
          <p className="text-xs italic text-slate-500 dark:text-cinema-400">{helperText}</p>
        </div>
        <div className="text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md border bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-cinema-400 border-slate-200 dark:border-white/5">
          Ratio {aspectRatio}
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 p-4 rounded-3xl transition-all duration-300 border bg-slate-50 dark:bg-cinema-800/40 border-slate-200 dark:border-white/10 shadow-sm">
        ...
        <div className="md:col-span-5 lg:col-span-4">
          <div className={cn(
            ...
            value 
              ...
              : "bg-slate-100 dark:bg-white/5 border-slate-300 dark:border-white/10 hover:border-brand-500/50 hover:bg-brand-50/20 dark:hover:bg-white/10"
          )}>
            {value ? (
              <>
                <img 
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center space-y-2">
                <div className="p-3 rounded-2xl shadow-sm mb-1 group-hover:scale-110 transition-transform duration-300 bg-white dark:bg-white/5">
                  <ImageIcon className="w-8 h-8 text-slate-400 dark:text-cinema-400" />
                </div>
                <p className="text-xs font-medium uppercase tracking-widest text-slate-400 dark:text-cinema-500">No Image</p>
              </div>
            )}

            {/* Loading Overlay */}
            {isWorking && (
              <div className="absolute inset-0 backdrop-blur-[2px] flex flex-col items-center justify-center z-10 animate-in fade-in duration-300 bg-white/60 dark:bg-cinema-900/60">
        ...
        <div className="md:col-span-7 lg:col-span-8 flex flex-col">
          ...
          <div className="flex border-b mb-6 border-slate-200 dark:border-white/5">
            <button
              type="button"
              ...
              className={cn(
                ...
                activeTab === 'file' 
                  ? "text-brand-500" 
                  : "text-slate-500 dark:text-cinema-400 hover:text-slate-900 dark:hover:text-white"
              )}
            >
          ...
          <div className="flex-1 flex flex-col">
            {activeTab === 'file' ? (
              <div className="animate-in fade-in slide-in-from-bottom-2">
                <p className="text-sm mb-6 leading-relaxed text-slate-600 dark:text-cinema-300">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isWorking 
                      ? "bg-slate-200 dark:bg-white/5 text-slate-400 dark:text-cinema-500 cursor-not-allowed" 
              ...
              <div className="animate-in fade-in slide-in-from-bottom-2">
                <p className="text-sm mb-4 leading-relaxed text-slate-600 dark:text-cinema-300">
                ...
                <div className="space-y-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled={isWorking}
                      className="w-full pl-12 pr-4 py-3.5 rounded-2xl border text-sm transition-all focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 bg-white dark:bg-cinema-800 border-slate-200 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-cinema-500"
                    />
                  </div>
                  <button
                    type="button"
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3.5 text-white bg-brand-500 hover:bg-brand-600 rounded-2xl font-bold transition-all shadow-lg shadow-brand-500/20 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <Check className="w-5 h-5" />
                    Xác nhận URL
                  </button>
