...
const NAV_ITEMS = [
  ...
  { href: "/admin/combos", icon: PackageOpen, label: "Combo & Bắp nước" },
...
export function AdminLayout() {
  ...
  const handleSearch = (e) => {
    if (e.key === 'Enter') {
      ...
      if (q) {
        toast.success(`Đang tìm kiếm: ${q}... Chức năng tìm kiếm tổng hợp đang được phát triển.`);
        e.target.value = '';
      }
    }
  };
  ...
  return (
    ...
    >
      ...
      <motion.aside
        ...
        className="flex-shrink-0 bg-slate-900 flex flex-col overflow-hidden relative z-20"
      >
        {/* Logo */}
        <div
          className={cn(
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header
          ...
          px-6 gap-4 flex-shrink-0 shadow-sm z-10"
        >
            ...
            <div className="relative max-w-xs w-full hidden md:block">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 text-sm bg-gray-50 border border-gray-200
                  ...
                  focus:border-brand-400 focus:bg-white transition-all shadow-sm"
              />
            </div>
          </div>
          <div className="flex items-center gap-4">
            <Link
              ...
              hover:text-brand-500 hover:shadow-sm transition-all"
              title="Thông báo"
            >
            ...
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="flex items-center gap-2 rounded-full hover:ring-2 ring-gray-100 transition-all"
                title="Tài khoản"
              >
                <div
                  className="w-9 h-9 rounded-full bg-slate-900 flex items-center
                  justify-center text-white text-sm font-bold shadow-md"
                >
                  {user?.fullName?.[0] ?? "A"}
                </div>
              </button>
                  ...
                  >
                    <div className="px-4 py-3 border-b border-gray-100 mb-1">
                      ...
                      <p className="text-xs text-gray-500 truncate">
                        {user?.email || 'admin@novaticket.vn'}
                      </p>
                    </div>
                    ...
                    <Link
                      ...
                      className="flex items-center gap-3 px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 hover:text-brand-500 transition-colors"
                    >
