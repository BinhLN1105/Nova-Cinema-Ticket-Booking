...
1. Mở Postman local, import file collection [NOVATicket.postman_collection.json](file:///.../qa-tests/postman/NOVATicket.postman_collection.json) và file môi trường [NovaTicket-Local.postman_environment.json](file:///.../qa-tests/postman/environment/NovaTicket-Local.postman_environment.json).
...
2. Export file Environment JSON đè lên file cũ tại: `qa-tests/postman/environment/NovaTicket-Local.postman_environment.json`.
