...
public class BookingResponse {
    ...
    @SerializedName("moviePosterUrl") private String moviePosterUrl;
    @SerializedName("startTime")      private String startTime;
    @SerializedName("cinemaName")     private String cinemaName;
    @SerializedName("cinemaAddress")  private String cinemaAddress;
    @SerializedName("screenName")     private String screenName;
    @SerializedName("subtotal")       private double subtotal;
    @SerializedName("discountAmount") private double discountAmount;
    ...
    @SerializedName("combos")         private List<ComboItem> combos;
    ...
    public static class ComboItem {
        @SerializedName("comboName") private String comboName;
        @SerializedName("quantity")  private int quantity;
        @SerializedName("unitPrice") private double unitPrice;
        @SerializedName("subtotal")  private double subtotal;
