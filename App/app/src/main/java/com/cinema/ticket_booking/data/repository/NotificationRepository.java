...
public class NotificationRepository {
    ...
    @Inject public NotificationRepository(ApiService api) { this.api = api; }
    ...
    public LiveData<Resource<PageResponse<NotificationResponse>>> getNotifications(int page) {
        ...
        api.getNotifications(page, 20).enqueue(new Callback<>() {
            @Override public void onResponse(Call<ApiResponse<PageResponse<NotificationResponse>>> c,
                ...
                else r.setValue(Resource.error("Tải thông báo thất bại"));
            }
            @Override public void onFailure(Call<ApiResponse<PageResponse<NotificationResponse>>> c, Throwable t) {
