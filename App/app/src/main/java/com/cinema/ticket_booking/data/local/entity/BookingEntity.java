...
public class BookingEntity {
    ...
    public BookingEntity(@NonNull String id, String bookingCode, String movieTitle,
        ...
        this.id = id; this.bookingCode = bookingCode; this.movieTitle = movieTitle;
        this.moviePosterUrl = moviePosterUrl; this.startTime = startTime;
        this.cinemaName = cinemaName; this.status = status;
        this.totalAmount = totalAmount; this.createdAt = createdAt;
    }
